    ...
    <nav class="navbar navbar-dark bg-primary navbar navbar-expand-lg" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <?php if ($mobo == "index.php") { ?>

                    <?php if ($dir1 == 'index.php') { ?>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="View/listar_mercados.php">Mercados</a>
                        </li>
                <?php }
                } ?>
            ...
            <form class="d-flex" role="search" action="<?php echo $mobo; ?>" method="POST">
